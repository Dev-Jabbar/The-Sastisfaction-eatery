...
import Stew from "../static/stew.jpg";
import Noodles from "../static/noodles.jpg";
import Curry from "../static/curry.jpg";
      ...
      <div className="grid md:grid-cols-3  ">
        <div className="md:col-span-1 md:flex md:justify-end">
          <nav className="text-right">
            ...
            <ul className={`md:block ${Hidden} text-sm mt-6`}>
        ...
        <main className=" px-16 py-6 bg-gray-100 md:col-span-2">
          ...
          <header>
            ...
            <h3 className="text-2xl font-semibold">For Our Customers</h3>
          </header>
          ...
          <div>
            ...
            <div className="mt-8  lg:grid grid-cols-3 gap-10 ">
              ...
              <div className="card">
                ...
                <div className="m-4">
                  <span className="font-bold">Tufo curry</span>
                  <span className="block text-gray-500 text-sm ">
                    Recipe by mario
                  </span>
                </div>
